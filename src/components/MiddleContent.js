...
export default function MiddleContent() {
  ...
  <path fill="#ffc244" fill-opacity="1" d="M0,288L80,245.3C160,203,320,117,480,96C640,75,800,117,960,138.7C1120,160,1280,160,1360,160L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
</svg>
<div className='middlecontent'>
  ...
  <Button>Scopri la nostra selezione</Button>
           ...
           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
  <path fill="#ffc244" fill-opacity="1" d="M0,288L80,245.3C160,203,320,117,480,96C640,75,800,117,960,138.7C1120,160,1280,160,1360,160L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path>
</svg> 
        </div>
    )
}
